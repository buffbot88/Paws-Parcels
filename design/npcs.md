...
>   regenerated Clover Village map layout — see `scripts/generate-clover-village.mjs`).
...
- **Home:** `zone-clover-village` @ (37,24)
...
- **Home:** `zone-clover-village` @ (56,40)
...
- **Home:** `zone-clover-village` @ (19,30)
...
- **Home:** `zone-clover-village` @ (52,28)
