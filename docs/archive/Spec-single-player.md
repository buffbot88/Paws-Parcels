...
>
> This is the **original single-player cozy RPG product specification**, preserved
> for history. It was superseded on **2026-08-03 (Phase 3.5 documentation pivot)** by
> the current [`BuildPlan.md`](../../BuildPlan.md) and the design docs under
> [`design/`](../../design/) (classes, combat, quests, monsters, dungeons, crafting,
> architecture, database schema, network protocol).
>
> **Do not implement features from this document.** Its "Explicitly Out of Scope"
> items (multiplayer, combat, cloud accounts, online database) are now **in scope**.
> Status marker: 🗃 archived

# Paws & Parcels — Product Specification (ARCHIVED — single-player)
1. Game Overview
