...
const usedRules = [
  ...
  { label: "Clover Village authored ground", test: /^new\/CloverValley\/Ground\/(meadow|road|plaza)\.png$/i },
  { label: "Happy Valley authored ground", test: /^new\/HappyValley\/Ground\/(valley-meadow|valley-path)\.png$/i },
  ...
  { label: "Clover Valley scenery props", test: /^new\/CloverValley\/Props\/(bench|bridge|cafe-table|clothesline|entrance-arch|garden-bed|lamp-post|lily-pads|mailbox|picnic-setup|pond-area|quest-items|quest-items\.2|rabbit-burrow)\.png$/i },
